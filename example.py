# -*- coding: UTF-8 -*-
# code from shiyanlou https://www.shiyanlou.com/
...
def encodeDataInImage(image, data):
    ...
    encodedPixels = [(r + int(binary[index * 4 + 0]), g + int(binary[index * 4 + 1]), b + int(binary[index * 4 + 2]),
                      t + int(binary[index * 4 + 3])) if index * 4 < len(binary) else (r, g, b, t)
...
if __name__ == '__main__':
    encodeDataInImage(Image.open("pic1.png"),
                      'Hello world!,Hello world,Hello world,Hello world!,Hello world,Hello world').save('pic2.png')
